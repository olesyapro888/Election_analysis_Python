...
# Close the file. #election_data.close()
  ...
  for row in file_reader:
    ...
    total_votes += 1
    # Get the candidate name (3 column as 2 index of row) from each row
    ...
    # To count a value by setting each candidate's vote count to zero in IF statement
      candidate_votes[candidate_name] = 0
  
    # Add a vote to that candidate's count for the dictionary
